...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="171" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/_ teruggenomen producten (per jaar).md" data-api-port="8001"></div>
