...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="228" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/Duurzaamheidsdataplatform met ETL_APIs.md" data-api-port="8001"></div>
