...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="115" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/Reductiedoel CO₂ (% t.o.v. basisjaar).md" data-api-port="8001"></div>
