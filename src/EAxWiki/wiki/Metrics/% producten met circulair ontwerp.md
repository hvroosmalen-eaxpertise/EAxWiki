...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="167" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/% producten met circulair ontwerp.md" data-api-port="8001"></div>
