...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="198" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/Elektriciteitsverbruik (Scope 2).md" data-api-port="8001"></div>
