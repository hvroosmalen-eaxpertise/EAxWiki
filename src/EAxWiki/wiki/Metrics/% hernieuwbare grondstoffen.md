...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="118" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/% hernieuwbare grondstoffen.md" data-api-port="8001"></div>
