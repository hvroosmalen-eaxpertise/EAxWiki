...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="235" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/% Gerecycled materiaal = (gerecycled _ totaal input) × 100.md" data-api-port="8001"></div>
