...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="142" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Task/Maak een publiek impactrapport over emissies, afval, water en circulariteit..md" data-api-port="8001"></div>
