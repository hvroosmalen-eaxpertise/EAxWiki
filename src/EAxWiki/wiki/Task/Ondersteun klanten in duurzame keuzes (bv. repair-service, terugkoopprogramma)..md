...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="145" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Task/Ondersteun klanten in duurzame keuzes (bv. repair-service, terugkoopprogramma)..md" data-api-port="8001"></div>
