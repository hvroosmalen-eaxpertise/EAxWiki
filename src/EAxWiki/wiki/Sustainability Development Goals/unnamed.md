...
**Type:** Boundary  **Stereotype:**   **Status:** <span class="status-badge status-proposed">Proposed</span>  
...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="630" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Sustainability Development Goals/unnamed.md" data-api-port="8001"></div>
