...
- To enable live editing from the wiki (status, notes, diagram descriptions, and attribute/method/tagged value descriptions — round-trip to EA), use `export-and-serve.ps1 --api-port 8001` instead of `serve.ps1`. This starts the wiki write-back server alongside MkDocs.
