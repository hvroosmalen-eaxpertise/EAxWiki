...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="154" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Task/Identificeer uitstootbronnen (scope 1, 2, 3) en ontwikkel reductieplannen..md" data-api-port="8001"></div>
