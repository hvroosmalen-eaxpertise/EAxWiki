...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="150" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Task/Optimaliseer processen voor minder energie_waterverbruik en minder restmateriaal..md" data-api-port="8001"></div>
