...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="151" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Task/Installeer zonnepanelen of stap over op groene energie en elektrische voertuigen..md" data-api-port="8001"></div>
