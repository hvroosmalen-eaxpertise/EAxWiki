...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="146" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Task/Ontwerp een klantreis met minimale afvalproductie en transparante impactcommunicatie..md" data-api-port="8001"></div>
