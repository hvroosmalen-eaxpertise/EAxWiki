...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="156" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Task/Ontwerp producten die modulair, repareerbaar en recyclebaar zijn..md" data-api-port="8001"></div>
