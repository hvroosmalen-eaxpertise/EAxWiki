...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="149" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Task/Investeer in circulaire capaciteit — training, tools, software, machines..md" data-api-port="8001"></div>
