...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="153" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Task/Voer een volledige LCA uit op product- en procesniveau..md" data-api-port="8001"></div>
