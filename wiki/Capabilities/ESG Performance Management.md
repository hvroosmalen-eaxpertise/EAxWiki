...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="445" data-status="" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Capabilities/ESG Performance Management.md" data-api-port="8001"></div>
