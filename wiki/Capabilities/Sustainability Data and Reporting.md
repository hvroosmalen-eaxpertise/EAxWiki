...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="448" data-status="" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Capabilities/Sustainability Data and Reporting.md" data-api-port="8001"></div>
...
| Name | Value | Notes |
|------|-------|-------|
| archimate_element_identifier | capability-005 |  |
