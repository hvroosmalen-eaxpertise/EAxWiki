...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="741" data-status="" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Organisation/OrganizationAssociation.md" data-api-port="8001"></div>
