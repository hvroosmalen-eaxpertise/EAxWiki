...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="748" data-status="" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Organisation/OrganizationExternalIdentifier.md" data-api-port="8001"></div>
