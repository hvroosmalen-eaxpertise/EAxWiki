...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="453" data-status="" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Courses of Action/Introduce Sustainable Product Design Process.md" data-api-port="8001"></div>
