...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="816" data-status="" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Products/ProductLifeCycleStage.md" data-api-port="8001"></div>
