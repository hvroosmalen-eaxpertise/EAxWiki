...
// Reset the graph to its auto-generated layout. Any dragged positions vanish and the
// working state is cleared so a page refresh doesn't snap the nodes back to where the
...
function restoreLayout(cy) {
    ...
    appendStatus('Reset to auto-layout.');
    return true;
}
...
function initEaGraph() {
    ...
    if (typeof EAxIcons !== 'undefined') {
        ...
        EAxIcons.set(restoreBtn, 'restore-layout', 'Reset to auto-layout');
