...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="755" data-status="" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Facilities/Location.md" data-api-port="8001"></div>
