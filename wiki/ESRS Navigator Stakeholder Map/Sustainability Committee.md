...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="243" data-status="" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="ESRS Navigator Stakeholder Map/Sustainability Committee.md" data-api-port="8001"></div>
