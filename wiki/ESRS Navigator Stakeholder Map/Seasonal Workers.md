...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="318" data-status="" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="ESRS Navigator Stakeholder Map/Seasonal Workers.md" data-api-port="8001"></div>
