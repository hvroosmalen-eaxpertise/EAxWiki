...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="268" data-status="" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="ESRS Navigator Stakeholder Map/COO.md" data-api-port="8001"></div>
