...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="346" data-status="" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="ESRS Navigator Stakeholder Map/Training Providers.md" data-api-port="8001"></div>
