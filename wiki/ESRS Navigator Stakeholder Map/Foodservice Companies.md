...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="253" data-status="" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="ESRS Navigator Stakeholder Map/Foodservice Companies.md" data-api-port="8001"></div>
