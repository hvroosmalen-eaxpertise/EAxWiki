...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="232" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/Product Carbon Footprint = totale CO₂e _ aantal eenheden geproduceerd.md" data-api-port="8001"></div>
