...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="226" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/Slimme afvalweegschalen, product-IoT.md" data-api-port="8001"></div>
