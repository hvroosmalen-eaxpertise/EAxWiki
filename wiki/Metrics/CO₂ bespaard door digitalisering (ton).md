...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="173" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/CO₂ bespaard door digitalisering (ton).md" data-api-port="8001"></div>
