...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="209" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/Datakwaliteit_ beschikbaarheid _ updatefrequentie.md" data-api-port="8001"></div>
