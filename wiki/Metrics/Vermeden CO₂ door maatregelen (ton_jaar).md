...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="181" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/Vermeden CO₂ door maatregelen (ton_jaar).md" data-api-port="8001"></div>
