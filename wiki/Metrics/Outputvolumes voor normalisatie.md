...
<div id="ea-notes-editor" class="ea-notes-editor" data-ea-id="196" data-file-path="Metrics/Outputvolumes voor normalisatie.md" data-api-port="8001">
...
<tr><td>EDGY::MetricValue</td><td>&lt;VALUE&gt;</td><td><span class="ea-row-notes-text"><!--ea-row-notes-start:tag-1-->Default: <VALUE><!--ea-row-notes-end:tag-1--></span><button class="ea-row-notes-edit-btn" type="button" data-surface="table-row" data-row-id="tag-1" data-notes-hash="40d9c7ee" data-kind="tagged-value" data-el-id="196" data-tag-name="EDGY::MetricValue" data-tag-value="&lt;VALUE&gt;" data-file-path="Metrics/Outputvolumes voor normalisatie.md" data-api-port="8001" aria-label="Edit description">&#9998;</button></td></tr>
