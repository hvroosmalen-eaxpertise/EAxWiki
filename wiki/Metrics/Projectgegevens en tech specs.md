...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="202" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/Projectgegevens en tech specs.md" data-api-port="8001"></div>
