...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="215" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/Productiesoftware (SCADA, MES).md" data-api-port="8001"></div>
