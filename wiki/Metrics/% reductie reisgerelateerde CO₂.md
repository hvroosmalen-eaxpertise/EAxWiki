...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="178" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/% reductie reisgerelateerde CO₂.md" data-api-port="8001"></div>
