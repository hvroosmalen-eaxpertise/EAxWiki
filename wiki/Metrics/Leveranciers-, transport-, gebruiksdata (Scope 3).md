...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="199" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/Leveranciers-, transport-, gebruiksdata (Scope 3).md" data-api-port="8001"></div>
