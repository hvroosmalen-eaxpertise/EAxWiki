...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="214" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/IoT op apparatuur.md" data-api-port="8001"></div>

## Relationships

| Type | Stereotype | Connected To |
|------|------------|-------------|
| Association | Link | [Energie, materiaal, water, afval per eenheid](Energie, materiaal, water, afval per eenheid.md) |
