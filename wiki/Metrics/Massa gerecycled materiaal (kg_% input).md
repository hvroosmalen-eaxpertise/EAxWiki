...
**Status:** <span id="ea-status-editor" class="ea-status-editor" data-ea-id="203" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/Massa gerecycled materiaal (kg_% input).md" data-api-port="8001"><span class="status-badge status-proposed">Proposed</span><button class="ea-status-edit-btn" type="button" aria-label="Edit status">&#9998;</button></span>  
**Created:** 2025-12-03  **Modified:** 2025-12-03


[Home](../index.md) / [Edgy](../Edgy/index.md) / [Metrics](index.md)

<div id="ea-notes-editor" class="ea-notes-editor" data-ea-id="203" data-file-path="Metrics/Massa gerecycled materiaal (kg_% input).md" data-api-port="8001">
