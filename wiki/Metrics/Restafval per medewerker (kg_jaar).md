...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="188" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/Restafval per medewerker (kg_jaar).md" data-api-port="8001"></div>
