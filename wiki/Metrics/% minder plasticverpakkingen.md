...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="170" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/% minder plasticverpakkingen.md" data-api-port="8001"></div>
