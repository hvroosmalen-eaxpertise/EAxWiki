...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="201" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/Emissie vóór_na project.md" data-api-port="8001"></div>
