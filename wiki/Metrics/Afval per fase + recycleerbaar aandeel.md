...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="205" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/Afval per fase + recycleerbaar aandeel.md" data-api-port="8001"></div>
