...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="193" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/Aantal duurzame assets (bv. EV's, zonnepanelen).md" data-api-port="8001"></div>
