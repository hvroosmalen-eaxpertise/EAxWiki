...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="184" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/_ bomen geplant _ ha natuur hersteld.md" data-api-port="8001"></div>
