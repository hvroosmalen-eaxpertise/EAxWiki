...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="230" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/% Hernieuwbare Energie = (opgewekte hernieuwbare energie _ totaal verbruik) × 100.md" data-api-port="8001"></div>
