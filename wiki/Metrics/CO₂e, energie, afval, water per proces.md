...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="207" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/CO₂e, energie, afval, water per proces.md" data-api-port="8001"></div>
