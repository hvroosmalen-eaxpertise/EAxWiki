...
<tr><td>EDGY::MetricValue</td><td>&lt;VALUE&gt;</td><td><span class="ea-row-notes-text"><!--ea-row-notes-start:tag-1-->Default: <!--ea-row-notes-end:tag-1--></span><button class="ea-row-notes-edit-btn" type="button" data-surface="table-row" data-row-id="tag-1" data-notes-hash="c1f81883" data-kind="tagged-value" data-el-id="194" data-tag-name="EDGY::MetricValue" data-tag-value="&lt;VALUE&gt;" data-file-path="Metrics/Energie, materiaal, water, afval per eenheid.md" data-api-port="8001" data-api-token="396808bb42d562fe840c39b8d02ecae080faf57660476df3" aria-label="Edit description">&#9998;</button></td></tr>
...
|------|------------|-------------|
| Aggregation | Tree | [Totaal afval (ton/jaar)](Totaal afval (ton_jaar).html) |
| Association | Link | [IoT op apparatuur](IoT op apparatuur.html) |
