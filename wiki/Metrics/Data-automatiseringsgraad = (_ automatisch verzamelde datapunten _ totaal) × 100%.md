...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="236" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/Data-automatiseringsgraad = (_ automatisch verzamelde datapunten _ totaal) × 100%.md" data-api-port="8001"></div>
