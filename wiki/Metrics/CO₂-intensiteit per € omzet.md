...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="169" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Metrics/CO₂-intensiteit per € omzet.md" data-api-port="8001"></div>
