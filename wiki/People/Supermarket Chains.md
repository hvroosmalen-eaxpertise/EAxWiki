...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="515" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="People/Supermarket Chains.md" data-api-port="8001"></div>
