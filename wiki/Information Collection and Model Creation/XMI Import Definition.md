...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="586" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Information Collection and Model Creation/XMI Import Definition.md" data-api-port="8001"></div>
