...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="587" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Information Collection and Model Creation/Stakeholder Map.md" data-api-port="8001"></div>
