...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="4" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Sustainability Development Goals/SDG  2. Zero Hunger.md" data-api-port="8001"></div>
