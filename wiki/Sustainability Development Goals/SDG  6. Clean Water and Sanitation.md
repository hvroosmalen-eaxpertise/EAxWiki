...
<div id="ea-status-editor" class="ea-status-editor" data-ea-id="8" data-status="Proposed" data-options='["Approved","Implemented","Mandatory","Proposed","Validated"]' data-file-path="Sustainability Development Goals/SDG  6. Clean Water and Sanitation.md" data-api-port="8001"></div>
